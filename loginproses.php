...
<!-- Jumbotron -->
<div class="jumbotron" >
	<div class="container text-center h3 alert alert-dark" role="alert">
	<?php
	include "koneksi.php";
	...
	if($cek){
		...
		Silahkan Menuju Halaman<br><br>
		<a href = "index.html" class="badge badge-light">HOME</a>
		<a href = "admin.php" class="badge badge-dark">Admin</a>
	<?php
	}else{
		echo "Anda gagal login.Silakan ";?><br><br>
		<a href="login.html" class="badge badge-light">Kembali</a>
		<a href="signup.html" class="badge badge-dark">Daftar</a>
	<?php
